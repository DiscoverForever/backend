...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "username":"SAMPLE_TEXT", "password":"SAMPLE_TEXT", "nickname":"SAMPLE_TEXT", "avatar":"SAMPLE_TEXT", "age":"0", "sex":null, "email":"SAMPLE_TEXT", "mobilePhoneNumber":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
